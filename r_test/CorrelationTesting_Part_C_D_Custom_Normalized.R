...
cor_metrics <- data.frame(
  ...
  filename = c(
    "correlation_plant_communities_part_c_d_custom_normalized.png",
    "correlation_habitat_types_part_c_d_custom_normalized.png",
    "correlation_plant_species_part_c_d_custom_normalized.png"
  )
)
...
write.csv(correlation_results, file.path(output_folder_path, "correlation_summary_part_c_d_custom_normalized.csv"), row.names = FALSE)
...
model_plant_communities_lm_residuals_path <- file.path(output_folder_path,"model_plant_communities_lm_residuals_part_c_d_custom_normalized.png")
...
model_plant_communities_lm_model_summary_path <- file.path(output_folder_path,"model_plant_communities_lm_model_summary_part_c_d_custom_normalized.txt")
...
model_habitat_types_lm_residuals_path <- file.path(output_folder_path,"model_habitat_types_lm_residuals_part_c_d_custom_normalized.png")
...
model_habitat_types_lm_model_summary_path <- file.path(output_folder_path,"model_habitat_types_lm_model_summary_part_c_d_custom_normalized.txt")
...
model_plant_species_lm_residuals_path <- file.path(output_folder_path,"model_plant_species_lm_residuals_part_c_d_custom_normalized.png")
...
model_plant_species_lm_model_summary_path <- file.path(output_folder_path,"model_plant_species_lm_model_summary_part_c_d_custom_normalized.txt")
