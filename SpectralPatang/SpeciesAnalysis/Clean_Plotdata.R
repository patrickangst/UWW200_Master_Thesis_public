...
# Load data
shannon_img_path <- '~/GitHub/UWW200_Master_Thesis_public/SpectralPatang/data/ang20190706t235120rfl/result/ang20190706t235120_rfl_v2v2_img_rectified/SPCA/PCA/OutputPCA_30_PCs_selection_cutline.tif'
csv_path <- "~/GitHub/UWW200_Master_Thesis_public/SpectralPatang/data/ang20190706t235120rfl/data/species_analysis/06_Utqiagvik_IBP_R_Input.csv"
...
ggplot(plot_data, aes(x = Longitude, y = Latitude, color = Shannon_Index)) +
