...
process_subfolder <- function(subfolder_path) {
  ...
  rgb_image_folder_path <- file.path(subfolder_path,'data','rectified')

  rectrified <- rectify_Image(raw_image_folder_path,rgb_image_folder_path)
...
# Example usage
main_folder <- "~/Documents/GitHub/UWW200_Master_Thesis_public/SpectralPatang/test_data"  # Replace with your folder path
#main_folder <- "/Volumes/AvirisNG/osx/subzone_d"
