...
\usepackage{tikz}              % Required for flow diagram
...
% My (Patricks) packages
\usepackage{float}
% \usepackage{url}        % REMOVED: Redundant and conflicting
% \usepackage{breakurl}   % REMOVED: breakurl is obsolete, url package handles this
% \usepackage[hyphens]{url} % REMOVED: Pass options directly
\usepackage{acro}
\usepackage{amsmath}
...
% --- THIS IS THE CORRECT WAY to customize the title for 'acro' package ---
\acsetup{list/name = {List of Abbreviations and Acronyms}}
\input{Front/acronyms.tex} % Keep this line as is